...
fn print_next_steps(mode: BootMode) {
    ...
    match mode {
        ...
        BootMode::Windows2000 => {
            ...
            println!("usbwin USB; first-boot of the installed system currently needs a");
            ...
            println!("resolve the system disk. Until the usbwin phase-3 fixer lands");
            ...
            println!("    - Remove the usbwin USB and boot natively. Win2k's GUI-mode");
